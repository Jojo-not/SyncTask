...
import { Calendar, Clock, Flag, CheckCircle, Edit3, Trash2 } from 'lucide-react';
...
const TaskCard = ({ task, onEdit, onDelete, onMarkComplete }) => {
  const getPriorityColor = (priority) => {
    switch (priority) {
      ...
      case 'low': return 'text-accent-600 bg-accent-50 dark:bg-accent-900/20';
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'in-progress': return 'text-primary-600 bg-primary-50 dark:bg-primary-900/20';
      case 'pending': return 'text-warning-600 bg-warning-50 dark:bg-warning-900/20';
      default: return 'text-gray-600 bg-gray-50 dark:bg-gray-700';
    }
  };
