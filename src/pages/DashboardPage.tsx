          ...
          <div className="px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">Total Tasks</p>
              </div>
              <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6">
              ...
              <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">High Priority</p>
              </div>
            </div>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-neutral-200 dark:divide-neutral-700">
                    {filteredTasks.map((task) => (
                      <tr key={task.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-700/50">
